...
# Corrected imports for the new package structure
...
# FIX 1: Use the new model name and remove the deprecated parameter
...
query = "how many total hours of classes do i have in 7th semester"
relevant_docs = vector_store.get_relevant_documents(query)
print("Generating answer...")

# FIX 2: Use the modern .invoke() method
